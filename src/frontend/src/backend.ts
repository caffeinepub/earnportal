...
export class Backend implements backendInterface {
    ...
    async approvePayment(arg0: string, arg1: boolean): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async claimPayment(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.claimPayment(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitUserDetails(arg0: string, arg1: bigint, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitUserDetails(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
